...
import Button from '../../components/PresetButton/PresetButton'
import Card from '../../components/PresetCard/PresetCard'
...
export default function Presets({ onNavigateStage = () => {} }: ElevateVizProps) {
  useEnsureVisualizerCatalog()
  ...
  return (
    <section className={`${styles.root} preset-library-tab`}>
