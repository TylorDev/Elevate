...
import styles from './VisualizerCanvas.module.scss'
import type { ElevateVizAudioGraph } from '../../types'
...
export default function VisualizerCanvas({
  audio,
  presetName,
  canvasRefExternal = null
}: VisualizerCanvasProps) {
  const { audioElement, audioContext: audioCtx, sourceNode: source } = audio
  ...
  }, [audioCtx, audioElement, hasDimensions, source, startRenderLoop, stopRenderLoop])
