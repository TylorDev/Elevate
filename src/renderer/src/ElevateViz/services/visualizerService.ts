import type { VisualizerPersistence, VisualizerPersistenceResult } from '../types'

async function invokeVisualizer(
  channel: string,
  payload?: unknown
...
export const electronVisualizerPersistence: VisualizerPersistence = {
...
export const visualizerService = electronVisualizerPersistence
